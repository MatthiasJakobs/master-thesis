...
for i in ["images", "annotations", "indices/train/1", "indices/train/2", "indices/train/3", "indices/test/1", "indices/test/2", "indices/test/3", "indices/val/1", "indices/val/2", "indices/val/3"]:
...
def create_fragments(train, val, split):
...
create_fragments(False, False, split)
create_fragments(True, True, split)
create_fragments(True, False, split)