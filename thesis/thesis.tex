...
\newcommand \Autor{Matthias Jakobs}
\newcommand \Titel{End-to-end Human Activity
Recognition on Video Datasets}
\newcommand \Untertitel{Master thesis}
%other information
\newcommand{\Supervisor}{Prof. Dr.-Ing. Gernot A. Fink\xspace}
\newcommand{\otherSupervisor}{Fernando Moya Rueda, M.Sc.\xspace}
...
% Language Options
% -------------------------------------------------------------------
\selectlanguage{english} % american english
...
\newcommand{\sref}[1]{(\textbf{Sec.} \ref{#1})}
...
\include{chapter/02-Fundamentals}
\include{chapter/03-Related-Work}
\include{chapter/04-Methods}
\include{chapter/05-Experiments}
