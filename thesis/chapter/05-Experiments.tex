...
Also, the approach for computing ground truth bounding boxes, as well as preprocessing the \textit{fragments} is identical to the one presented earliner.
However, it was decided to introduce additional augmentation since the dataset is smaller and because it was observed that the HAR models were overfitting on the training data.
...
% TODO
% TODO: Mention how loss was computed
...
%test 83.95 and 66.92 for pck_bb_0.2 and pck_upper_0.2
...
While the authors do not motivate their use of momentum, it is typically used for faster convergence, because it adds a fraction $\gamma$ of the previous 
