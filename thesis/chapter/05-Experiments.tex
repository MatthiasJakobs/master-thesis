...
% test results at iteration 230000
%[ 0.51048951 0.48913043 0.56326531 0.6147541  0.37967914 0.52054795
%  0.57915058 0.         0.65779468 0.77394636 0.3269962  0.39694656
%  0.53030303 0.48288973 0.3460076  0.35384615]
%  mean_acc_single, mean_acc_multi, mean_bb_02, mean_bb_01, mean_upper_02
%  (0.6714276075363159, 0.6793071031570435, 0.8223645687103271, 0.48881927132606506, 0.3428668975830078)

%TODO: explain why it didnt work (or why it did)

\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.8\textwidth]{cm-e2e.png}
    \caption{TODO}
    \label{fig:cm-e2e}
\end{figure}