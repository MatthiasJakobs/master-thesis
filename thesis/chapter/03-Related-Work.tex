...
The authors also evaluate the effect of adding their representation to other previous approaches and find that adding it to the previous state-of-the-art approach by \cite{carreira_quo_2017} (see \sref{sec:two-stream}) they were able to improve the accuracy slightly by $0.5$ ($87.9$ percent as opposed to $87.4$ percent) percentage points using estimated poses on the JHMDB dataset.
