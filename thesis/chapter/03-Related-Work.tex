...
The authors use two metrics.
\textit{PCKh} as their metric for the MPII dataset, which is very similar to both PCK \sref{sec:andriluka-eval} and PDJ \sref{sec:flic-lsp}.
However, instead of using the person bounding box or torso bounding box for normalization, PCKh uses the head.
