...
From now on, the term \textit{multi-layer perceptron} and \textit{neural network} are used interchangeably as long as the properties discussed apply to both.
...
See XX for a visualization. %TODO BILD
...
After convolution and pooling layer for extracting features, many use cases require a classification step.
...
In the contxt of CNNs, these layers are referred to as \textbf{fully-connected} layers.
