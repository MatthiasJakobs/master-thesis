...
\begin{myframe}[Stacking architectures - Qualitative evaluations]
    \begin{figure}
        \includegraphics[width=0.45\textwidth]{stacked-qualitative-results.png}
        \caption{\textbf{Left half:} Intermediate results after two consecutive hourglasses. \textbf{Right half:} Final results after eight consecutive hourglasses. \fcite{newell_stacked_2016}}
    \end{figure}
    \begin{figure}
